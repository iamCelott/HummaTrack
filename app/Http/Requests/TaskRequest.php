...
class TaskRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'department_id.required' => 'Deparment ID wajib diisi.',
            'department_id.integer' => 'Deparment ID harus berupa angka.',
            'department_id.exists' => 'Deparment ID yang dipilih tidak valid.',
