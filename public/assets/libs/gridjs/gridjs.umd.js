!(function (t, n) {
    ...
    function Et() {
        return (function (t) {
            ...
            return (
                (e.c = t),
                n
                    ? (null == e.__ && ((e.__ = !0), n.sub(ot)), n.props.value)
                    : t.__
            );
        })(cn);
    }
    ...
    function $t(t) {
        ...
        if (t.pluginId) {
            ...
            return o
                ? x(S, {}, x(o.component, r({ plugin: o }, t.props)))
                : null;
        }
                ...
                (t.createFromConfig = function (t) {
                    ...
                    return (
                        t.storage instanceof Zt &&
                            n.register(
                                new un({ serverStorageOptions: t.server })
                            ),
