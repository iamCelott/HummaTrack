    ...
    <main class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="md:flex hidden items-center gap-2.5 font-semibold">
                <div class="flex items-center gap-2">
                    <a href="#" class="text-sm font-medium text-slate-700 dark:text-slate-400">Calendar</a>
                </div>
                {{--
            <div class="flex items-center gap-2">
        ...
        <div class="grid lg:grid-cols-4 gap-6">
            <div class="card h-full min-h-full ">
                <div class="p-6">
                    <button class="px-3 py-2 rounded bg-primary text-white text-base w-full mb-4" id="btn-new-event"><i
                            class="mgc_add_line"></i> Create New Event</button>

                    <div class="flex flex-col gap-1" id="external-events">
                        <p class="text-sm text-slate-700 dark:text-slate-400 mb-4">Drag and drop your event or click in the
                            calendar</p>
                        <button
                        ...
                        <button class="external-event bg-info px-3 py-2 rounded text-white text-base text-start w-full mb-2"
                            data-class="bg-info">
